  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: "var(--cream)" }}>
        ...
        <div className="w-full max-w-2xl flex flex-col items-center gap-12">
          ...
          <div className="text-center">
            ...
            <p
              ...
              style={{ color: "var(--ink-muted)", fontFamily: "var(--font-geist-sans)", maxWidth: "36ch", margin: "1.5rem auto 0" }}
            >
              Paste an article URL. Highlight what matters. Share a link your friends can actually read.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="w-full flex flex-col gap-3">
            ...
            >
              {/* Link icon */}
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none" style={{ flexShrink: 0, color: "var(--ink-faint)" }}>
      ...
      >
        ...
        >
          Always links to the original — never reproduces content as your own.
        </p>
      </footer>
    </div>
  );
